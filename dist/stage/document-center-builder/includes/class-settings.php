...
final class DCB_Settings {
    ...
    public static function defaults(): array {
        return array(
            ...
            'dcb_upload_public_link_ttl_hours' => 168,
            'dcb_upload_frontend_batch_size' => 4,
    ...
    public static function register(): void {
        ...
        register_setting('dcb_settings_group', 'dcb_upload_public_link_ttl_hours');
        register_setting('dcb_settings_group', 'dcb_upload_frontend_batch_size');
