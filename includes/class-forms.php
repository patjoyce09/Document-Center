    ...
    public static function upload_shortcode(): string {
        ...
        <div class="th-upload-wrap">
            <div class="th-upload-card">
                ...
                <label for="th-upload-channel" style="display:block;margin:12px 0 8px;font-weight:600;">Intake Channel</label>
                    ...
                    <?php else : ?>
                        <?php foreach ($resource_rows as $row) : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($form_key !== '') : ?>
                                        <a class="button button-small" href="<?php echo esc_url(add_query_arg($fill_args, get_permalink())); ?>">Use Fillable Version</a>
                                    <?php else : ?>
                                        —
                                    <?php endif; ?>
                                </td>
